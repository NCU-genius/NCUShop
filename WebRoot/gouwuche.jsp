...
new CommDAO().commOper("UPDATE gouwuche SET xiaoji=(shangpinjiage*goumaishuliang) WHERE id='"+charuid+"'");
    ...
    new CommDAO().commOper("UPDATE gouwuche SET xiaoji=(shangpinjiage*goumaishuliang) WHERE id='"+request.getParameter("id")+"'");
