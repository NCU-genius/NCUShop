...
<div class="panel panel-default">
    ...
    分类
                            ...
                            <select class="form-control class_fenlei5" data-value="<%= request.getParameter("fenlei") !=null ? request.getParameter("fenlei") : "" %>" id="fenlei" name="fenlei">
...
<td> <% 
 HashMap mapshangpinfenlei9 = new CommDAO().find("SELECT fenlei FROM shangpinfenlei where id='"+map.get("fenlei")+"'"); 
 %><%= mapshangpinfenlei9.get("fenlei") %> </td>
...
<td> <%= map.get("goumaiyonghu") %> </td>
                                                    <td>
                                                                    <%= map.get("issh") %>
                                    <a href="sh.jsp?id=<%= map.get("id") %>&yuan=<%= map.get("issh") %>&tablename=gouwuche">
