...
<%
    ...
    HashMap map = new CommDAO().getmap(request.getParameter("id") , "huiyuan");
    %>
...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <select class="form-control class_xingbie20" data-value="<%= Info.html(map.get("xingbie")) %>" data-rule-required="true" data-msg-required="请填写性别" id="xingbie" name="xingbie" style="width:250px">
<option value="男">男</option>
<option value="女">女</option>

</select>
<script>
$(".class_xingbie20").val($(".class_xingbie20").attr("data-value"))</script>
