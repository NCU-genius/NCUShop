...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="dianpuxinxi.jsp?a=insert" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" readonly="readonly" id="dianpubianhao" name="dianpubianhao" value="<%= Info.getID() %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:250px;" data-rule-required="true" data-msg-required="请填写店铺名称" id="dianpumingcheng" name="dianpumingcheng" value=""/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    ...
    <input type="text" class="form-control" data-rule-required="true" data-msg-required="请填写店铺logo" id="dianpulogo" name="dianpulogo" value=""/>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <textarea style="width: 80%;height: 120px" class="form-control" data-rule-required="true" data-msg-required="请填写经营宗旨" id="jingyingzongzhi" name="jingyingzongzhi"></textarea>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <textarea data-rule-required="true" data-msg-required="请填写店铺介绍" id="dianpujieshao" name="dianpujieshao" style="max-width: 750px;width:100%; height: 300px;"></textarea><script>
            (function(){
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" readonly="readonly" id="shangjia" name="shangjia" value="<%= request.getSession().getAttribute("username") !=null ? request.getSession().getAttribute("username") : "" %>"/>                                            
        </div>
    </div>
</div>
                                <div class="form-group">
