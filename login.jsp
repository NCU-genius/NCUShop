                ...
                <div class="form-group mb-4">
                    <div class="input-group">
                        ...
                        <span class="input-group-append">
                            <img src="image.jsp" style="min-width: 60px;min-height: 30px;" onClick="this.src='image.jsp?time='+new Date().getTime();" alt="点击刷新">
                        </span>
                    </div>
                </div>
                <div class="form-group mb-4">
